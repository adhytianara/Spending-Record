...
public class AturAmountState extends AturState {
	...
	public AturState userInsertMoney(long userMessage) {
		this.messageToUser = "Oke, budget yang disediakan sebesar Rp" + userMessage +
				". Konfirmasi perubahan dengan menjawab 'Ya' atau ketik 'Batal' untuk membatalkan tindakan";
	...
	public AturState unknownMessage() {
		this.messageToUser = "Nominal uang tidak sesuai. Pastikan kamu hanya memasukkan angka, contoh: 10000. " +
